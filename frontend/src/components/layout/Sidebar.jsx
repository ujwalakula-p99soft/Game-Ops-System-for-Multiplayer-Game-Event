...
export default function Sidebar({ onClose }) {
  return (
    <aside className="w-56 shrink-0 bg-zinc-950 border-r border-zinc-800/70 flex flex-col h-screen sticky top-0">
      {/* Brand */}
      <div className="px-5 py-5 border-b border-zinc-800/70">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-white font-bold text-sm leading-none">GameOps</p>
            <p className="text-zinc-600 text-xs mt-0.5">Operations System</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 py-4 border-t border-zinc-800/70">
        <p className="text-zinc-700 text-xs">v1.0.0 · Backend API</p>
      </div>
    </aside>
  );
}
